...
**現在、追加機能追加後は購入者・出品者両者、評価済み後に商品ステータス更新**
...
| 商品ID | 商品名 | 価格 | 出品ユーザー |
|------|------|------|------------|
| CO01 | 腕時計 | 15,000円 | ユーザー1 |
| CO02 | HDD | 5,000円 | ユーザー1 |
| CO03 | 玉ねぎ3束 | 300円 | ユーザー1 |
| CO04 | 革靴 | 4,000円 | ユーザー1 |
| CO05 | ノートPC | 45,000円 | ユーザー1 |
| CO06 | マイク | 8,000円 | ユーザー2 |
| CO07 | ショルダーバッグ | 3,500円 | ユーザー2 |
| CO08 | タンブラー | 500円 | ユーザー2 |
| CO09 | コーヒーミル | 4,000円 | ユーザー2 |
| CO10 | メイクセット | 2,500円 | ユーザー2 |
